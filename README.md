...
# hello-rails_back_end

In this project I am working on backend part to create restful API that I am consuming in this `react app` https://github.com/Hamzaoutdoors/hello-react-front-end for frontend porpuses
...
```
$ git clone git@github.com:Hamzaoutdoors/hello-rails_back_end.git
```
 - Then go to the right folder 
```
$ cd hello-rails_back_end
```
```
$ bundle
```
...
```
 ...
 - Finaly run `rails s` and visit http://localhost:3000/v1/greetings in your browser to see the created API
...
Feel free to check the [issues page](https://github.com/Hamzaoutdoors/hello-rails-back-end/issues).
...
This project is [MIT](https://github.com/Hamzaoutdoors/hello-rails-back-end/blob/dev/LICENSE.md) licensed.
